...
CoD.T8AmmoWeaponImages = {
    ray_gun_zm = "ui_icon_weapons_zm_raygun",
    ray_gun_upgraded_zm = "ui_icon_weapons_zm_raygun",
    raygun_mark2_zm = "ui_icon_weapons_zm_raygun_mk2",
    raygun_mark2_upgraded_zm = "ui_icon_weapons_zm_raygun_mk2"
}
